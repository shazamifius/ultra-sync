...
function App() {
  ...
  const selectFolder = async (setter: (path: string) => void) => {
    try {
      console.log("Tentative d'ouverture de la boîte de dialogue...");
      ...
      console.error("Erreur explicite lors de l'appel à open():", e);
      alert(`Une erreur est survenue lors de l'ouverture de l'explorateur de fichiers : ${e}`);
    }
  };
